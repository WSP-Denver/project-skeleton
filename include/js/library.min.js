/**
 * @project        wspprojectskeleton
 * @author         Ben Rudolph, WSP <benjamin.rudolph@wsp.com>
 * @build          Tue, Jun 5, 2018 9:57 AM ET
 *
 */
...
$(document).ready(function() {
	...
	function checkViewWidth() {
		var mainWidth = Math.max(
			...
			window.innerWidth || 0
		); //Compares width among 3 arguments and determines mobile or desktop
		if (mainWidth >= 900) {
			//Tablet & Desktop
			stickyHeader();
		} else {
...
//JS FUNX FOR PARTIAL HTML INCLUDES
	function includePartial() {
		var a, i, elem, file, xhttp;

    a = document.getElementsByTagName('*');
    for (i = 0; i < a.length; i++) {
      elem = a[i];

      file = elem.getAttribute('include-content');
      ...
      if (file) {
        ...
        xhttp.onreadystatechange = function() {
          if (this.readyState == 4) {
            ...
            if (this.status == 404) {elem.innerHTML = "File/Include Missing";}
            elem.removeAttribute('include-content');
            includePartial();
          }
        }
